...
namespace WebBanGiay.API.Migrations
{
    ...
    [Migration("20260407184838_AddSales")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebBanGiay.API.Models.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "WELCOME10",
                            CreatedAt = new DateTime(2026, 4, 8, 1, 48, 34, 900, DateTimeKind.Local).AddTicks(6135),
                        ...
                        new
                        {
                            Id = 2,
                            Code = "SAVE50K",
                            CreatedAt = new DateTime(2026, 4, 8, 1, 48, 34, 901, DateTimeKind.Local).AddTicks(4930),
                        ...
                        new
                        {
                            Id = 3,
                            Code = "FREESHIP",
                            CreatedAt = new DateTime(2026, 4, 8, 1, 48, 34, 901, DateTimeKind.Local).AddTicks(4941),
            ...
            modelBuilder.Entity("WebBanGiay.API.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            Color = "Đen",
                            CreatedAt = new DateTime(2026, 4, 7, 18, 48, 34, 901, DateTimeKind.Utc).AddTicks(6096),
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Color = "Trắng",
                            CreatedAt = new DateTime(2026, 4, 7, 18, 48, 34, 901, DateTimeKind.Utc).AddTicks(7136),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            Color = "Nâu",
                            CreatedAt = new DateTime(2026, 4, 7, 18, 48, 34, 901, DateTimeKind.Utc).AddTicks(7140),
            ...
            modelBuilder.Entity("WebBanGiay.API.Models.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebBanGiay.API.Models.SaleProduct", b =>
                {
            ...
            modelBuilder.Entity("WebBanGiay.API.Models.SaleProduct", b =>
                {
                    ...
                    b.HasOne("WebBanGiay.API.Models.Sale", "Sale")
                        .WithMany("SaleProducts")
